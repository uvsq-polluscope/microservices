...
def classification_v1(df, participant_virtual_id):
    ...
    dfs=splitting(df)
    labels,labels_Temperature,labels_Humidity,labels_NO2,labels_BC,labels_PM1,labels_PM25,labels_PM10,labels_Speed=predict_labels_raw_data_RF(dfs,model_path='./models_RF/',classes_removed=False)
    classes={}
